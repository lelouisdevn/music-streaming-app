...
<body>
    <div class="full">
        <form action="{{url('/user/login/authenticate')}}" method="post">
            {{csrf_field()}}
            <div class="container">
                <div class="logo">
                ...
                <div class="loginform">
                    ...
                    <div style="color: lightgrey; text-align: left; font-size: 18px; overflow: auto;">
                        <div style="float: left; width: 70%;">
                            Haven't registed one yet? Create <a style="color: lightgrey;" href="{{url('user/signup')}}">here!</a>
                        </div>    
                        <div style="float: right; width: 30%; text-align: right;">
                            <a href="{{ url('user/forgotPassword') }}" style="color: lightgrey;">Forgot password?</a>
                        </div>
                    </div>
                </div>
